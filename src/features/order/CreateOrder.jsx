...
export async function action({ request }) {
  ...
  //თუ ყველაფერი რიგზე იქნება,მხოლოდ ამის შემდეგ შეიქმნება neworder და გდავა რიდაირექტზე
  const newOrder = await createOrder(order);

  // არ არის კარგი მიდგომა,აქ რაც გვიწერია,როგორც წესი ჩვენ ჯერ ვქმნით useDispatch და შემდეგ ვიძახებთ მას კომპონენტში და არა ესეთ pure function ში.
